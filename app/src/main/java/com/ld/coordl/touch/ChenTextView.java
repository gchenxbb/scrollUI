...
/**
 */
public class ChenTextView extends AppCompatTextView {
    ...
    public ChenTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ChenTextView(Context context, AttributeSet attrs, int defStyle) {
