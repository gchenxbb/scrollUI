...
import com.ld.coordl.FloorType;
import com.ld.coordl.viewholder.ImageViewHolder;
import com.ld.coordl.viewholder.Item3Holder;
import com.ld.coordl.viewholder.ItemExpandedHolder;
import com.ld.coordl.viewholder.ItemMoreViewHolder;
import com.ld.coordl.entity.ItemEntry;
import com.ld.coordl.entity.MoreViewEntry;
import com.ld.coordl.R;
import com.ld.coordl.viewholder.TitleViewHolder;
...
public class BuAdapter extends BaseAdapter {
    ...
    private void bindCustomViewholderData(BaseRecycleViewHolder holder, int position) {
        ...
        if (holder instanceof ItemMoreViewHolder) {
            ...
            holder.setViewHolderData(entry, position);
